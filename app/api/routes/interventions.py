...
from app.services import intervention_service, evidence_service, pdf_service
...
def create_intervention(data: InterventionCreate, db: Session = Depends(get_db)):
    return intervention_service.create_intervention(db, data)
...
def add_asset(
    ...
    return intervention_service.add_asset_to_intervention(db, intervention_id, data)
...
async def upload_evidence(
    ...
    return await evidence_service.upload_evidence(db, intervention_id, file)
